          ...
          <div class="is-form-inner">
            ...
            >
              <VMessage color="primary">
                <div>
                  <strong class="pr-1">ایمیل:</strong>
                  <span>john.doe@cssninja.io</span>
                </div>
                <div>
                  <strong class="pr-1">رمز عبور:</strong>
              ...
              <div class="button-wrap has-help">
                ...
                <span>
                  یا
                  <RouterLink to="/auth/signup-1">ساخت </RouterLink>
               حساب کاربری.
                </span>
              </div>
            </form>
