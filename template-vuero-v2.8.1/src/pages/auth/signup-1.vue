...
useHead({
  title: 'ثبت نام احراز هویت 1 - Vuero',
})
</script>
      ...
      >
        <div class="steps-container">
          ...
          >
            ...
            <span class="step-label">تصویر پروفایل</span>
          </div>
          <div
            class="step-icon"
          ...
          >
            ...
            <span class="step-label">حساب</span>
          </div>
          <div
            class="step-icon"
          ...
          >
            ...
            <span class="step-label">تمام</span>
          </div>
          <progress
            class="progress"
            :value="step - 1"
          ...
          <div class="container">
            ...
            >
              <div class="column is-4 is-offset-1">
                ...
                >
                 شما هم عضو Vuero شوید
                </h1>
                <h2
                  id="main-signup-subtitle"
                  class="subtitle signup-subtitle"
                >
               و به سادگی به یک تجربه طراحی بی بدیل بپیوندید.
                </h2>
                <div class="signup-card">
                  ...
                  >
                        ...
                        <div class="signup-type">
                          ...
                          <div class="box-wrap">
                            ...
                            <div class="signup-box">
                              ...
                              <div class="meta">
                                <span>پولی</span>
                                <span>دریافت امکانات خیلی بیشتر</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="control is-agree">
                      <span>
                       با ادامه دادن با ما موافقت می کنید با  <a href="#">شرایط</a> و
                        <a href="#">حریم خصوصی</a>
                      </span>
                    </div>
            ...
            >
              ...
              >
                ...
                <div class="divider-container">
                  <div class="divider">
                    <span>یا یک اواتار انتخاب کنید</span>
                  </div>
                </div>
            ...
            >
              <div class="column is-4 is-offset-4 username-form">
                ...
                <h2 class="subtitle signup-subtitle has-text-centered">
                  نام کاربری شما نحوه یافتن شما توسط دیگران در Vuero است، بنابراین یک نام کاربری خوب انتخاب کنید. بعداً می توانید آن را تغییر دهید.
                </h2>
                <form
                  method="post"
                  novalidate
                    ...
                    <div class="column is-12">
                      <VField>
                        <VControl class="has-switch">
                          <VLabel>برای من ایمیل های بازاریابی و تراکنش بفرستید</VLabel>
                          <VSwitchBlock
                            color="success"
                            checked
                          />
