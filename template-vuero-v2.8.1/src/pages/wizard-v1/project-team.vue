    ...
    <div class="step-content">
      <div class="step-title">
        <h2 class="dark-inverted">
         چه کسی روی این پروژه کار خواهد کرد؟
        </h2>
        <p>با اضافه کردن اعضا به تیم خود شروع کنید</p>
      </div>
      ...
      <VPlaceholderPage
        ...
        class="is-people"
        title="دعوت  دوستان"
        subtitle="اگر امکانش را دارید، می توانید از قبل شروع به اضافه کردن فایل ها به پروژه خود کنید. اما نگران نباشید، بعداً می‌توانید فایل‌ها را اضافه و مدیریت کنید."
        larger
      >
        <template #image>
          <img
      ...
      >
        ...
        <div class="project-team-body">
          <div class="members-list">
            ...
            >
              <span>هنوز هیچ عضوی از تیم وجود ندارد</span>
            </div>
          </div>
        </div>
      </div>
