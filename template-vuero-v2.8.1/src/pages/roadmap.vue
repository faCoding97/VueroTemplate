...
const changeTypes = ['همه', 'بهبود', 'امکانات', 'رفع اشکال']
...
useHead({
  title: 'نقشه راه ابزار - سایدبار - Vuero',
})
</script>
            ...
            >
              <div class="roadmap-header has-text-centered">
                ...
                <div class="currently-planned">
                  <div>
                    <span>
                      {{ selectedQuarter }}ماهه  {{ selectedYear }} برنامه ریزی شده:
                      <span class="count">22 ویژگی</span>
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div v-else-if="activeValue === 'changelog'">
            ...
            >
              <div class="roadmap-header has-text-centered">
                ...
                <div class="currently-planned">
                  <div>
                    <span>30 روز گذشته : <span class="count">22 جدید</span></span>
                  </div>
                </div>
              </div>
                ...
                <div class="roadmap-toolbar">
                  <div class="start">
                    <VField
                      ...
                      class="is-autocomplete-select"
                    >
                      <VLabel>انواع ورودی</VLabel>
                      <VControl icon="feather:search">
                        <Multiselect
                          v-model="selectedChangeType"
                          :attrs="{ id }"
                          :options="changeTypes"
                          placeholder="انتخاب یک نوع..."
                          :searchable="true"
                        />
                      </VControl>
                    </VField>
