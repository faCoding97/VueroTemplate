        ...
        >
          ...
          <div class="sidebar-inner">
            ...
            <div class="inner-menu">
              <a class="button compose-button is-fullwidth">نوشتن</a>
            ...
            <div class="actions">
              <div class="control inbox-search has-icon">
                <input
                  ...
                  placeholder="جستجوی صندوق ورودی.."
                >
                <div class="form-icon">
                  <i
                    aria-hidden="true"
                  ...
                  <div class="dropdown-content">
                    <a class="dropdown-item">
                      <i
                        ...
                        data-icon="feather:check"
                      />
                      <span>علامت گذاری همه <br/>به عنوان خوانده</span>
                    </a>
                    <a class="dropdown-item">
                      <i
                        aria-hidden="true"
                      ...
                      />
                      <span>مخفی کردن <br/>خوانده شده</span>
                    </a>
                    ...
                    <a class="dropdown-item">
                      ...
                      />
                      <span>مرتب سازی بر <br/>اساس تاریخ</span>
                    </a>
                    <a class="dropdown-item">
                      <i
                        aria-hidden="true"
                      ...
                      />
                      <span>مرتب سازی بر<br/> اساس کاربر</span>
                    </a>
                  </div>
                </div>
              </div>
