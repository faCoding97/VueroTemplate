...
// Click handler to toggle کردن  conversations
...
useHead({
  title: 'چت پیام رسانی - سایدبار - Vuero',
})
                  ...
                  <div class="control">
                    <div class="easy-autocomplete">
                      <input
                        ...
                        class="input"
                        aria-label="به"
                        placeholder="برای شروع گفتگو نام یک کاربر را تایپ کنید"
                      >
                    </div>
                    <div class="icon">
                      <span>به:</span>
              ...
              <template #body>
                ...
                >
                  ...
                  <div class="text">
                    ...
                    <p>مکالمه را با تایپ یک پیام شروع کنید</p>
                  </div>
                </li>
