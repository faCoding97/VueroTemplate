    ...
    >
      ...
      <div class="demo-actions">
        <a
          ...
          v-tooltip.rounded="`باز کردن با VS Code (حالت توسعه دهنده)`"
          class="code-edit"
        ...
        <a
          v-if="githubIssueUrl"
          v-tooltip.rounded="`گزارش مشکل در GitHub`"
          class="report-issue"
          :href="githubIssueUrl"
          target="_blank"
        ...
        <span
          v-if="hasCodeSample"
          v-tooltip.rounded="displayCode ? 'Hide source code' : `مشاهده کد منبع`"
        ><a
          class="code-trigger"
          role="button"
          tabindex="0"
