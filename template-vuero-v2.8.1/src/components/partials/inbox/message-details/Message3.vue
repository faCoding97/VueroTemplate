  ...
  >
    <div class="header-area">
      ...
      <div class="message-meta">
        <span class="message-title"> فراموش نکنید که  یادداشت های بودجه را برای من ارسال کنید</span>
      ...
      <div class="message-inner">
        <div class="message-head">
          <div class="info">
            ...
            <span>20 شهریور 1402 در 08:46 ق.ظ</span>
          </div>
       ...
       لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان
          ...
          <ul>
            ...
            <li>
              نامفهوم از صنعت چاپ، و با استفاده از طراحان نامفهوم از صنعت چاپ، و با استفاده از طراحان نامفهوم از صنعت چاپ، و با استفاده از طراحان
            </li>
            <li>ز صنعت چاپ، و با استفاد.</li>
            <li>
           لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان
            </li>
            <li>
          ...
          <p>
            <mark>
           لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</mark>
