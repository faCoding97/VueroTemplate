      ...
      <div class="message-inner">
        <div class="message-head">
          <div class="info">
            ...
            <span>19 شهریور 1402, در  07:48 ب.ظ</span>
          </div>
          ...
          <p>
           وقتی ثروت‌ های بزرگ به دست برخی مردم می‌افتد در پرتو آن نیرومند می‌شوند و در سایهٔ نیرومندی و ثروت خیال می‌ کنند که می‌توانند در خارج از وطن خود زندگی نمایند و خوشبخت و سرافراز باشند ولی به زودی می‌ فهمند که اشتباه کرده‌ اند و عظمت هر ملتی بر روی خرابه‌ های وطن خودش می‌باشد و بس!
            ...
            <a href="http://loripsum.net/">
             وقتی ثروت‌ های بزرگ به دست برخی مردم می‌افتد ;</a>
           وقتی ثروت‌ های بزرگ به دست برخی مردم می‌افتد در پرتو آن نیرومند می‌شوند و در سایهٔ نیرومندی و ثروت خیال می‌ کنند که می‌توانند در خارج از وطن خود زندگی نمایند
          </p>
          <ul>
            <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</li>
            <li>لورم ایپسوم متن ساختگی با.</li>
            <li>لورم ایپسوم متن ساختگی با لورم ایپسوم متن ساختگی با.</li>
            <li>لورم ایپسوم متن ساختگی با لورم ایپسوم متن ساختگی با لورم ایپسوم متن ساختگی با.</li>
          </ul>

          <p>بعد از کارت با من تماس بگیر حتما.</p>
        </div>
