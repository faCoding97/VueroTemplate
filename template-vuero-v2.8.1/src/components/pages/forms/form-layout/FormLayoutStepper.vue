          ...
          <div class="form-section-inner">
            <VField>
              <VControl>
                <VInput
                  type="text"
                  placeholder="این محموله در مورد چیست؟"
                />
              </VControl>
            </VField>
            ...
            <VField>
              <VControl>
                ...
                >
                  ...
                  />
                  <span>اضافه کردن گروه حمل و نقل</span>
                </button>
              </VControl>
            </VField>
            ...
            <div class="fieldset">
              ...
              <VField>
                <VLabel>مدت زمان (روز)</VLabel>
                <VControl>
                  <VInput
                    type="number"
                    placeholder="مدت زمان انبار را وارد کنید"
                  />
                </VControl>
              </VField>
            ...
            <div class="form-section-inner">
              <VField>
                <VControl>
                  <VInput
                    type="text"
                    placeholder="شناسه مالیاتی شرکت"
                  />
                </VControl>
              </VField>
                  ...
                  <VField>
                    <VControl>
                      <Multiselect
                        ...
                        :options="['فرم W-12', 'فرم W-12a ', 'فرم-Z']"
                        placeholder="صورت های مالیاتی"
                      />
                    </VControl>
                  </VField>
                </div>
              ...
              <div class="options">
                ...
                <VField class="option">
                  ...
                  <div class="option-inner">
                    ...
                    />
                    <h4>گزارش های BI</h4>
                    <p>گزارش های سفارشی ساخته شده</p>
                  </div>
                </VField>
            ...
            <div class="form-section-inner">
              <div class="validation-box">
                <div class="box-content">
                  <h3>عالی</h3>
                  <p>
                    قبل از ارسال فرم، مطمئن شوید که تمام فیلدهای لازم را پر کرده اید. پس از ارسال، نمی‌توانید اطلاعات این محموله را تغییر دهید.
                  </p>
                </div>
      ...
      <div class="form-stepper">
        ...
        >
          ...
          >
            ...
            <h3>اطلاعات عمومی </h3>
            <p>
          لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ Sed quod proximum
              ...
              <ul>
                <li>
                  <i
                    ...
                    data-icon="feather:check"
                  />
                  <span>برخی از آیتم های لیست  مناسب</span>
                </li>
                <li>
                  <i
                    aria-hidden="true"
