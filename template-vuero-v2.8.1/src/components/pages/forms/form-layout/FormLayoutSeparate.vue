                      ...
                      :options="[
                        {
                          value: 'iran',
                          name: 'ایرانی',
                          icon: '/images/icons/flags/iran.png',
                        },
                        {
                          value: 'english',
                          name: 'انگلیسی',
              ...
              <div class="column is-12">
                <VField>
                  ...
                  <VControl>
                    ...
                    <p>
                      <span>تاریخ تحویل تخمینی: <span>23شهریور </span></span>
                      <span>هر بسته یک شماره پیگیری داردr</span>
                    </p>
                  </VControl>
                </VField>
              </div>
