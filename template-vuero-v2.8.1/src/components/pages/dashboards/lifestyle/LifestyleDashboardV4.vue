          ...
          <div class="column is-12">
            <div class="illustration-header-2">
              ...
              <div class="header-meta">
                <h3>سلام علی</h3>
                <p>
                 آیا ایده ای برای مقاله جدید دارید؟ اگر نه، حتما باید فید را برای الهام گرفتن بررسی کنید.
                </p>
                <VButton
                  light
                  outlined
            ...
            <div class="updates">
              ...
              <div class="updates-list">
                ...
                <div class="update-item is-dark-bordered-12">
                  ...
                  <span class="dark-inverted">23شهریور </span>
                </div>
                <!--Update-->
                <div class="update-item is-dark-bordered-12">
                  <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
            ...
            <div class="articles-feed-list-inner">
              ...
              <a class="articles-feed-item">
                ...
                <div class="featured-content">
                  <h4 class="dark-inverted">یادگیری رمان مدرن</h4>
                  <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
              ...
              <a class="articles-feed-item">
                ...
                <div class="featured-content">
                  <h4 class="dark-inverted">5 نکته برای نوشتن</h4>
                  <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
