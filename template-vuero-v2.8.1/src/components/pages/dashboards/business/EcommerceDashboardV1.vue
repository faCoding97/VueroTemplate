  ...
  <div class="ecommerce-dashboard ecommerce-dashboard-v1">
    ...
    <div class="dashboard-header">
      ...
      <div class="start">
        ...
        <p>بسیار خوشحالیم که دوباره شما را در داشبورد خود می بینیم.</p>
      </div>
      <div class="end">
        <VButton dark="3">
          مشاهده گزارشات
    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-3">
        <div class="dashboard-tile">
          ...
          <div class="dashboard-tile-inner">
            <div class="left">
              <span class="dark-inverted">389.9K تومان</span>
            </div>
            <div class="right">
              <ApexChart
                id="spark2"
      ...
      <div class="column is-6">
        <LineStatWidget
          ...
          current-value="75,648.43 تومان"
          previous-label="ماه پیش"
          previous-value="91,512.18 تومان"
          straight
        >
          <ApexChart
      ...
      <div class="column is-6">
        <GroupedStatWidget
          ...
          :labels="['معاملات جدید', 'پیشنهادات', 'معاملات بسته']"
        >
          <template #chart1>
            <ApexChart
              id="group-radial-1"
        ...
        >
          <template #body-cell="{ row, column, value }">
            ...
            <template v-else-if="column.key === 'amount'">
              <span class="dark-inverted is-weight-600">{{ row.amount }} تومان</span>
            </template>
