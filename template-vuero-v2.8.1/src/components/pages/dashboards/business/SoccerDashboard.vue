            ...
            <div class="match">
              <div class="left">
                <img
                  ...
                  alt=""
                >
                <span class="team-name">بارسلونا</span>
              </div>
              <div class="center">
          ...
          <div class="leagues">
            ...
            <div class="leagues-list">
              ...
              >
                ...
                >
                <div class="meta">
                  <span class="league-name">لیگ  1</span>
                  <span class="league-country">فرانسه</span>
                </div>
                <div class="end">
                  <span>8 مسابفه</span>
                </div>
              ...
              >
                ...
                >
                <div class="meta">
                  <span class="league-name">لالیگا</span>
                  <span class="league-country">اسپانیا</span>
                </div>
                <div class="end">
                  <span>8 مسابفه</span>
                </div>
              ...
              >
                ...
                >
                <div class="meta">
                  <span class="league-name">لیگا</span>
                  <span class="league-country">پرتقال</span>
                </div>
                <div class="end">
                  <span>8 مسابفه</span>
                </div>
              ...
              >
                ...
                >
                <div class="meta">
                  <span class="league-name">بوندس لیگا</span>
                  <span class="league-country">آلمان</span>
                </div>
                <div class="end">
                  <span>8 مسابفه</span>
                </div>
        ...
        <div class="column is-8">
          ...
          <div class="dashboard-cta">
            ...
            <h2 class="dashboard-cta-title">
             در مسابقه ما برنده جوایز عالی شوید
            </h2>
            <p class="dashboard-cta-text">
             پیش بینی کنید که چه کسی برنده خواهد شد و یک مسابقه چگونه به پایان می رسد و شانس بردن جوایز نقدی باورنکردنی را داشته باشید.
            </p>
            <VButton
              color="light"
              bold
          ...
          <div class="matches-card">
            ...
            <div class="matches-card-header">
              ...
              <ul class="header-nav">
                <li class="nav-item">
                  <a class="nav-link is-active">همه</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link">زنده</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link">تمام شده</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link">برنامه ریزی شده</a>
                </li>
              </ul>
            </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span class="stadium">کمپ نو</span>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="stadium">برنابئو</span>
                    </td>
                    <td>
                      <a class="table-action">
                        <i
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="stadium">آرسنال</span>
                    </td>
                    <td>
                      <a class="table-action">
                        <i
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="stadium">گودیسون پارک</span>
                    </td>
                    <td>
                      <a class="table-action">
                        <i
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="stadium">خوزه زوریلا</span>
                    </td>
                    <td>
                      <a class="table-action">
                        <i
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="stadium">پارک دو پرنس</span>
                    </td>
                    <td>
                      <a class="table-action">
                        <i
