...
const tagsOptions = [
  { value: 'web-developer', label: 'فرانت اند' },
        ...
        <div class="search-type">
          <div class="alert">
           ...
           ایجاد آگهی شغلی
            ...
            اکنون یک آگهی شغلی ایجاد کنید و شغل مناسب خود را از دست ندهید.
            </div>
            <VField>
