          ...
          <div class="course-card">
            <span
              ...
              :class="[
                ...
                course.category === 'کاردیولوژی' && 'is-danger',
              ]"
            ...
            <div class="attached-block">
              <a class="is-dark-primary">ضبط سخنرانی هفته ششم</a>
          ...
          <div class="tile-grid-item-inner">
            ...
            <div class="meta">
              ...
              <span>
                ...
                />
                <span>به روز رسانی  : {{ file.uploaded }}</span>
              </span>
            </div>
            <FileTileDropdown />
          </div>
            ...
            <template v-if="column.key === 'picture'">
              ...
              <div>
                ...
                <span class="item-meta">
                  <span>{{ row.progress }}% کامل کرده</span>
                </span>
              </div>
            </template>
