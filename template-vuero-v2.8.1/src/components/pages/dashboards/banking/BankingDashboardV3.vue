...
<template>
  <div class="banking-dashboard banking-dashboard-v3">
    ...
    <div class="dashboard-header">
      <div class="left">
        <span>آخرین نمودار قیمت بیت کوین (BTC).</span>
        <div class="currency">
          <span class="amount is-positive dark-inverted">10584.30 تومان</span>
        </div>
      </div>
      <div class="right">
        <div class="buttons">
      ...
      <div class="column is-8">
        ...
        <div class="dashboard-tiles">
          ...
          <div class="dashboard-tile">
            ...
            <span class="dark-inverted">129,992,260,090 تومان</span>
          </div>
          <!--Tile-->
          <div class="dashboard-tile">
            <span>حجم 24 ساعت</span>
            <span class="dark-inverted">453,178  هزار تومان</span>
          </div>
          <!--Tile-->
          <div class="dashboard-tile">
            <span>کم/بالا 24 ساعت</span>
            <span class="dark-inverted">10,212 تومان - 10,584 تومان</span>
          </div>
        </div>
