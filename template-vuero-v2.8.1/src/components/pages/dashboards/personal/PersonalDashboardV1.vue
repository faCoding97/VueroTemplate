...
<template>
  <div class="personal-dashboard personal-dashboard-v1">
    ...
    <div class="dashboard-header">
      ...
      />
      <div class="start">
        <h3>خوش آمدید علی زمانی</h3>
        <p>بسیار خوشحالیم که دوباره شما را در داشبورد شخصی خود می بینیم.</p>
      </div>
      <div class="end">
        <VButton dark="3">
          مشاهده گزارشات
        ...
        <div class="column is-4">
          <div class="dashboard-card is-upgrade">
            ...
            <div class="cta-content">
              <h4>علی! داری عالی عمل می‌کنی.</h4>
              <p class="white-text">
              استفاده از ابزارهای مدیریت پروژه و تیم ما را شروع کنید
              </p>
              <a class="link inverted-text">اطلاعات بیشتر</a>
            </div>
          </div>
        </div>
