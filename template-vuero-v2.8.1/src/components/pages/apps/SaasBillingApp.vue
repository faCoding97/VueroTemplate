            ...
            <div class="plan-description">
              ...
              <div class="right">
                <div class="plan-pricing">
                  ...
                  <span> صورتحساب سالانه  {{ selectedPlan.costs.yearly }}  </span>
                </div>
                <div class="plan-moto">
                  <p>
                    {{ selectedPlan.intro }}
              ...
              <div class="plan-features">
                <div class="columns">
                  <div class="column is-6">
                    <div class="content">
                      <ul>
                        <li>{{ selectedPlan.limits.seats }} جایگاه</li>
                  ...
                  <div class="column is-6">
                    <div class="content">
                      <ul>
                        <li>به روز رسانی زنده</li>
                        <li>پرداخت</li>
                        <li>{{ selectedPlan.limits.addons }} پلاگین</li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <VField class="option-block">
          ...
          <div class="block-body">
            ...
            <VControl subcontrol>
              <VSwitchBlock
                v-model="warnBilling"
                label="قبل از پایان دوره صورتحساب به من اطلاع دهید"
                color="primary"
              />
            </VControl>
          </div>
