          ...
          <div class="expanded-content">
            ...
            >
              ...
              >
                ...
                >
                <p class="empty-text">
                فعلاً تسک جدیدی برای تأیید وجود ندارد.
                </p>
              </div>
              ...
              >
                ...
                <footer class="card-footer">
                  <a class="card-footer-item">مشاهده</a>
                  <a
        ...
        >
          ...
          <div class="expanded-content">
            <div class="column-title">
              ...
              >
              <h3>
                <span class="column-name">در حال انجام</span>
                <span class="task-count">{{ progressTasks.length }}</span>
              </h3>
            ...
            >
              ...
              >
                ...
                >
                <p class="empty-text">
                در حال حاضر هیچ تسکی در حال انجام نیست.
                </p>
              </div>
        ...
        >
          ...
          <div class="expanded-content">
            <div class="column-title">
              ...
              >
              <h3>
                <span class="column-name">آماده</span>
                <span class="task-count">{{ readyTasks.length }}</span>
              </h3>
            ...
            >
              ...
              >
                ...
                >
                <p class="empty-text">
                  <span>در حال حاضر هیچ تسکی به عنوان آماده علامت گذاری نشده است.</span>
                  <a
                    href="#"
        ...
        >
          ...
          <div class="expanded-content">
            <div class="column-title">
              ...
              >
              <h3>
                <span class="column-name">در حال بررسی</span>
                <span class="task-count">{{ reviewTasks.length }}</span>
              </h3>
            ...
            >
              ...
              >
                ...
                >
                <p class="empty-text">
                 در حال حاضر هیچ تسکی در حال بررسی نیست.
                </p>
              </div>
        ...
        >
          ...
          <div class="expanded-content">
            <div class="column-title">
              ...
              >
              <h3>
                <span class="column-name">تکمیل شده</span>
                <span class="task-count">{{ completedTasks.length }}</span>
              </h3>
