    ...
    <div class="list-view list-view-v4">
      ...
      >
        <div class="list-view-inner">
          <!--Empty placeholder-->
          <VPlaceholderPage
            title="هیچ دستور العمل ذخیره شده ای وجود ندارد."
            subtitle="به نظر می‌رسد در حال حاضر هیچ دستور پخت ذخیره‌شده‌ای ندارید. با کاوش جدیدترین‌ها شروع کنید و موارد دلخواه خود را به بخش دستور العمل‌های ذخیره شده اضافه کنید."
            larger
          >
            <template #image>
              <img
