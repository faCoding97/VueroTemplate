    ...
    <div class="list-view list-view-v2">
                    ...
                    <span>
                      {{
                        item.details.bathrooms > 1
                          ? `${item.details.bathrooms} سرویس  بهداشتی`
                          : `${item.details.bathrooms} سرویس  بهداشتی`
                      }}
                    </span>
                  </span>
      ...
      >
        <div class="list-view-inner">
          <!--Empty placeholder-->
          <VPlaceholderPage
            title="هیچ ویژگی غیر فعالی وجود ندارد."
            subtitle="به نظر می رسد هیچ ویژگی غیرفعالی برای نمایش وجود ندارد. شما می توانید یک ویژگی را از تنظیمات ویژگی غیرفعال و همچنین فعال کنید."
            larger
          >
            <template #image>
              <img
