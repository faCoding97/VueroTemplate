  ...
  <div>
    ...
    <div class="user-grid user-grid-v3">
      ...
      >
        <!--Empty placeholder-->
        <VPlaceholderPage
          title="اعضای تیم وجود ندارد."
          subtitle="به نظر می رسد هنوز هیچ عضوی از تیم ندارید. وقتی شروع کنی
با اضافه کردن تعدادی به تیم خود، آنها در اینجا نشان داده می شوند."
        >
          <template #image>
            <img
