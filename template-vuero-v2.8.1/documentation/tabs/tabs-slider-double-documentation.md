...
برای جزئیات بیشتر نشانه گذاری را بررسی کنید. این تب ها فقط از 2 آیتم پشتیبانی می کنند.
...
<VTabs slider type="rounded" selected="team" :tabs="[{ label: 'تیم', value: 'team' },{ label: 'پروژه ها', value: 'projects' }]">
  <template #tab="{ activeValue }">
    <p v-if="activeValue === 'team'">
